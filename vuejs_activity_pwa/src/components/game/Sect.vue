<template>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="image_1"><img src="assets/game/images/img-1.png"></div>
              </div>
            </div>
            </div>
    ...
    <div class="about_section layout_padding">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="image_2"><img src="assets/game/images/img-2.png"></div>
          </div>
          <div class="col-md-6">
    ...
    <div class="product_section layout_padding">
      <div class="container">
        ...
        <div class="product_section_2">
          <div class="row">
            <div class="col-md-6">
              <div class="image_2"><img src="assets/game/images/img-3.png"></div>
    ...
    <div class="video_section layout_padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image_4"><img src="assets/game/images/img-4.png"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="testimonial_section layout_padding">
      <div class="container">
        ...
        <div class="testimonial_section_2">
          <div class="box_main">
            <div class="quote_icon"><img src="assets/game/images/quote-icon.png"></div>
            ...
            <div class="client_main">
              <div class="client_left">
                <div class="images_5"><img src="assets/game/images/img-5.png"></div>
              </div>
    ...
    <div class="contact_section layout_padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="image_6"><img src="assets/game/images/img-6.png"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="section_footer ">
      <div class="container"> 
        ...
        <div class="social_icon">
          <ul>
            <li><a href="#"><img src="assets/game/images/fb-icon.png"></a></li>
            <li><a href="#"><img src="assets/game/images/twitter-icon.png"></a></li>
            <li><a href="#"><img src="assets/game/images/linkdin-icon.png"></a></li>
            <li><a href="#"><img src="assets/game/images/instagram-icon.png"></a></li>
          </ul>
        </div>
      </div>
    </div>
